...
public class Address2 {
  ...
  public Address2(String addressLine1, String addressLine2, String addressLine3,
  ...
  public void printStatus() {
    System.out.print("Address: " + this.addressLine1 + ", " + this.addressLine2
        + ", " + this.addressLine3
